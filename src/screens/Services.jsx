...
const Services = () => {
  ...
  return (
    ...
    <>
      ...
      <>
        <div className='h-[1300px] xl:h-[1000px]'>
          <Appbar />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2  gap-2 mt-5 h-[400px]'>
              ...
              <div className='order-2 md:border-l-4 border-[#f0008c] rounded text-white '>
                ...
                <div className='flex justify-center align-middle py-2 '>
                  ...
                  <ol className='list-disc'> {/* Service Lists */}
                    {card.branches.map((branch, index) => {
                      return (
                        <motion.li
                          variants={listVariants(Number(`0.${index}`))}
                          initial="hidden"
                          animate="visible"
                          key={index} className=' xl:mt-5 text-xl md:text-3xl'>{branch}</motion.li>
                      )
                    })}
                  </ol>
