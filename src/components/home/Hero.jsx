...
const Hero = () => {
  ...
  return (
    <>
      <div id='hero' className='relative font-poppins'>
        <Navbar />
        {images.map((image, index) => (
          <LazyLoadImage
            ...
            className={`absolute top-0 w-full h-[500px] md:object-cover lg:h-screen -z-10 transition-all duration-500 ${index === currentIndex ? "opacity-100" : "opacity-0"
              }`}
            effect="opacity"
          />
        ))}
