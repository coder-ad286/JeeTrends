...
import Lipstick from '../../assets/images/Comedian_Images/Permanent_Lipstick.jpg'
import Eyebrow from '../../assets/images/Comedian_Images/Permanent_Eyebrows.jpg'
      ...
      <motion.div
        ...
        <div>
          ...
          <div className='grid grid-cols-4 gap-3'>
            <div className='rounded col-span-2 lg:col-span-1 flex items-center'>
